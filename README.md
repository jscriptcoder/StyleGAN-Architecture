...
## Datasets
- [Anime Face Dataset](https://github.com/SiskonEmilia/Anime-Wifu-Dataset)
- [Flickr-Faces-HQ Dataset (FFHQ)](https://github.com/NVlabs/ffhq-dataset)

## Implementations
- [StyleGAN — Official TensorFlow Implementation](https://github.com/NVlabs/stylegan)
- [Style-Based GAN in PyTorch](https://github.com/kayoyin/FakeCelebs)
- [StyleGAN.pytorch](https://github.com/huangzh13/StyleGAN.pytorch)
- [StyleGAN-PyTorch](https://github.com/SiskonEmilia/StyleGAN-PyTorch)
- [A PyTorch Implementation of StyleGAN (Unofficial)](https://github.com/tomguluson92/StyleGAN_PyTorch)
- [StyleGAN_demo](https://github.com/SunnerLi/StyleGAN_demo)
- [Style-Based GAN in PyTorch](https://github.com/rosinality/style-based-gan-pytorch)
- [PyTorch implementation of Progressive Growing of GANs](https://github.com/jeromerony/Progressive_Growing_of_GANs-PyTorch)
- [Progressive-GAN-pytorch](https://github.com/odegeasslbc/Progressive-GAN-pytorch)
- [Pytorch Implementation of "Progressive growing GAN (PGGAN)"](https://github.com/nashory/pggan-pytorch)
- [Pytorch implementation of A Style-Based Generator Architecture for GAN](https://github.com/caffeinism/StyleGAN-pytorch)
